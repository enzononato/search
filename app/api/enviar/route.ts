  ...
  await withTransaction(async (client) => {
    ...
    await client.query(
      `INSERT INTO pesquisa_ti.respostas (
        ...
        comentario_avaliacao_equipamento, acessorios_notebook,
        usa_celular_corp, avaliacao_celular, comentario_avaliacao_celular,
        avaliacao_atendimento, comentario_avaliacao_atendimento,
        avaliacao_presenca, comentario_avaliacao_presenca, resolucao_tempo,
      ...
      [
        ...
        payload.comentario_avaliacao_equipamento,
        payload.acessorios_notebook,
        payload.usa_celular_corp,
        payload.avaliacao_celular,
        payload.comentario_avaliacao_celular,
        payload.avaliacao_atendimento,
        payload.comentario_avaliacao_atendimento,
        payload.avaliacao_presenca,
        payload.comentario_avaliacao_presenca,
